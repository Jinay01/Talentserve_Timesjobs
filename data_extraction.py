...
def jobs(url):
    ...
    storage.database_storage(company, time_period, salary, location,
                             description, job_details, skills_required, company_details_dict, url)
